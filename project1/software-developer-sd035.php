<!-- Filename: software-developer-sd035.html
...
<?php include "header.inc"; ?>
        ...
        <main class="job_details_main">
            ...
            <section>
                <h2>Software Developer Ref: SD035</h2>
                <div class="job_details">
                    <p>Full time Position</p>
                    <p>Location: Melbourne VIC</p>
                    <p>Salary Range: $100,000 - $140,000</p>
                    <p>Close date: 23 APRIL, 2025</p>
                ...
                <ul>
                    ...
                    <li>
                    Experience with JavaScript, C# and modern frontend frameworks such
                    as React
                    </li>
                </ul>
